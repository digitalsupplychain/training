...
public class NoteKeeperProvider extends ContentProvider {
    ...
    public String getType(Uri uri) {
        ...
        switch(uriMatch){
            case COURSES:
                // vnd.android.cursor.dir/vnd.com.schroeder.walter.notekeeper.provider.courses
...
//              content://com.schroeder.walter.notekeeper.provider/courses/1
                rowUri = ContentUris.withAppendedId(Courses.CONTENT_URI, rowId);
                break;
            case NOTES_EXPANDED:
//              throw exception saving that this is a read-only table
                break;
        }
        return rowUri;
    }
    ...
    private Cursor notesExpandedQuery(SQLiteDatabase db, String[] projection, String selection,
        ...
        for (int idx=0; idx < projection.length; idx++){
            columns[idx] = projection[idx].equals(BaseColumns._ID) ||
                    projection[idx].equals(CoursesIdColums.COLUMN_COURSE_ID) ?
