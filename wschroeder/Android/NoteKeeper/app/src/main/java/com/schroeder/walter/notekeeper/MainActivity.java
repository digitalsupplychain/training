...
import static com.schroeder.walter.notekeeper.NoteKeeperProviderContract.Notes.CONTENT_URI;

public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener,
                   LoaderManager.LoaderCallbacks<Cursor> {
    public static final int LOADER_NOTES = 3;
    private NoteRecyclerAdapter mNoteRecyclerAdapter;
    private RecyclerView mRecycleItems;
    private LinearLayoutManager mNotesLayerManager;
    ...
    private void initializeDisplayContent() {
        ...
        mNotesLayerManager = new LinearLayoutManager(this);
    ...
    private void displayNotes() {
        ...
        mRecycleItems.setLayoutManager(mNotesLayerManager);
    ...
    private void displayCourses() {
        ...
        mRecycleItems.setLayoutManager(mCoursesLayoutManager);
